...
let check_surface_area l w h expected =
  ...
  check int ("calculate_surface_area: " ^ Day02.to_string l w h) result expected

let check_extra_paper l w h expected =
  let result = Day02.calculate_extra_paper l w h in
  check int ("calculate_extra_paper: " ^ Day02.to_string l w h) result expected

let check_calc l w h expected =
  let result = Day02.calculate l w h in
  check int (Day02.to_string l w h) result expected

let check_parse_line str expected =
  let result = Day02.parse_line str in
  check (list int) ("parse_line: " ^ str) result expected

let check_parse_file str expected =
  let result = Day02.parse_file str in
  check int ("parse_file: " ^ str) result expected
